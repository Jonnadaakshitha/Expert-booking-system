...
const seedDB = async () => {
  try {
    ...
    await Expert.insertMany([
      ...
      { name: "Sarah", category: "Designing", experience: 5, rating: 4.9, availableSlots: ["09:00 AM", "01:00 PM"] },
      ...
      { name: "Michael UI", category: "Designing", experience: 7, rating: 4.8, availableSlots: ["02:00 PM", "05:00 PM"] },
